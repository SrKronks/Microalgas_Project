...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "synthetic_training": {
        ...
        "quality": {
            "enabled": True,
            "max_ks_value": 0.35,
            "max_out_of_real_range_pct": 15.0,
        },
    },
    "models": {
        "enabled_groups": {
    ...
    "classification": {
        ...
        "use_probabilities_as_regression_context": True,
        "save_models": True,
    },
    "sensitivity": {
        "enabled": True,
        "default_grid": {
            ...
            "synthetic_training.decline_probability": [0.40, 0.70, 0.90],
            "machine_learning.Random_Forest.n_estimators": [100, 300, 600],
